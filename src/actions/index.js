...
//const apiKey = "1981173e9" 
export function getMovies(titulo) {
    return function(dispatch) {
      return fetch("http://www.omdbapi.com/?apikey=198173e9&s=" + titulo)
        .then(response => response.json())
        .then(json => {
          dispatch({ type: GET_MOVIES, payload: json });
        })
        .catch(error => console.error(error));
    // const response = await fetch("http://www.omdbapi.com/?apikey=198173e9=" + titulo);
